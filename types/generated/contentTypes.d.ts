...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['tractor-parts', 'sub-assemblies', 'tractors']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEngineeringComponentEngineeringComponent
  ...
  info: {
    description: '';
    displayName: 'EngineeringComponent';
    pluralName: 'engineering-components';
    singularName: 'engineering-component';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSubAssemblySubAssembly extends Struct.CollectionTypeSchema {
  collectionName: 'sub_assemblies';
  info: {
    description: '';
    displayName: 'SubAssembly';
    pluralName: 'sub-assemblies';
    singularName: 'sub-assembly';
  };
  options: {
    draftAndPublish: true;
  };
